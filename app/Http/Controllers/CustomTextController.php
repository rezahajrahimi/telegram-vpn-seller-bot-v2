    ...
    public function seed()
    {
        ...
        if (CustomText::count() == 0) {
            $data = [
                ...
                ['key' => 'action.buy_history.title', 'default_text' => 'سابقه خرید', 'custom_text' => null],
                ['key' => 'action.buy_history.no_history', 'default_text' => 'شما هیچ سابقه خریدی ندارید', 'custom_text' => null],
                ...
                ['key' => 'action.web.auto_login_link', 'default_text' => "لینک ورود سریع به پنل: ", 'custom_text' => null],
